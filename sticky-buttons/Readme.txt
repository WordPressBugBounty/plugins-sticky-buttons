...
- [WP Coder](https://wordpress.org/plugins/wp-coder/) – Add custom HTML, CSS, PHP and JS code to your site easily.
...
👉 [View all plugins by Wow-Company](https://profiles.wordpress.org/wpcalc/#content-plugins)
...
= 4.2 =
* Added: Option “Mobile Rules” to control menu behavior on mobile devices*
